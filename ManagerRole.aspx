    ...
    <form id="form1" runat="server">
        ...
        <asp:Menu ID="Menu1" runat="server">
            <Items>
                ...
                <asp:MenuItem Text="Modules" Value="Modules">
                    <asp:MenuItem NavigateUrl="~/AddModules.aspx" Text="Add Modules" Value="Add Modules"></asp:MenuItem>
                    <asp:MenuItem NavigateUrl="~/ViewModules.aspx" Text="View Modules" Value="View Modules"></asp:MenuItem>
                </asp:MenuItem>
            </Items>
        </asp:Menu>
    </form>
